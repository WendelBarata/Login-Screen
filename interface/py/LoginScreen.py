...
import interface.py.icons_rc as icons_rc
...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnLogin.setText(QCoreApplication.translate(
            "MainWindow", u"Login", None))
        self.btnCancel.setText(QCoreApplication.translate(
            "MainWindow", u"Cancel", None))
        self.lbTitle.setText(QCoreApplication.translate(
            "MainWindow", u"LOGIN", None))
        self.lbName.setText("")
        self.lbPassword.setText("")
        self.lbSecretCode.setText("")
        self.leName.setPlaceholderText(QCoreApplication.translate(
            "MainWindow", u"Type your user", None))
        self.lePassword.setPlaceholderText(QCoreApplication.translate(
            "MainWindow", u"Type your password", None))
        self.leSecretCode.setPlaceholderText(
            QCoreApplication.translate("MainWindow", u"Secret Code", None))
